...
#define DebugPrintN(id, ...)        _DebugPrint##id(__VA_ARGS__)
#define DebugPrintLineN(id, ...)    _DebugPrintLine##id(__VA_ARGS__)
#define DebugWriteN(id, ...)        _DebugWrite##id(__VA_ARGS__)
